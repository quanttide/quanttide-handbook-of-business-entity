...
> 设计者注：初步评估是定价最重要的环节。章程第三章的四类要素（工作量、稀缺性、创新价值、长期价值）就是定价的四个锚点。你漏掉任何一个，报价就可能偏低。书面记录是为了让后续审批有据可查，也防止需求变来变去最后扯不清。
...
以[报价档案](../../profile/business/quotation.md)中让利规则为准。常规条款由各业务线确定（与章程第七条一致），让利幅度超出管理层规定比例须另行审批。
...
> 设计者注：谈判的核心不是"降多少"，而是"让对方理解价值"。章程第十七条的谈判原则写得很清楚——突出稀缺性与创新价值。被动降价会损害客户对你们专业度的认知。让利的唯一正当理由是长期合作价值：如果这次让利能换来一个持续合作的客户，那让利就是投资；否则就是单纯的价格损失。
